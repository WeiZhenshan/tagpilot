...
public interface TlObjectGroupExtMapper {
    ...
    /** 标签库关联数据集的在线版本ID */
    Long selectOnlineVersionId(@Param("libraryId") Long libraryId);
    ...
    /** 标签类型（tl_tag.tag_type，无则 null） */
    String selectTagTypeByField(@Param("libraryId") Long libraryId, @Param("fieldName") String fieldName);
