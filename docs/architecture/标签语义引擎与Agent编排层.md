...
> **2026-09-24 runtime 更新**：Agent 已在本地代码切换为 Claude Agent SDK。本文中的 LangGraph、检查点与旧循环时序属于迁移前说明；当前实现、启动配置和验证边界以 [SDK 重构实施记录](../development/Agent-SDK重构实施记录.md) 为准。语义层与 Java 权威边界继续适用。
