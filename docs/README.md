...
| 标签语义引擎与 Agent 编排层 | 架构 / 使用指南 | taglibrary + AI Runtime | [`architecture/标签语义引擎与Agent编排层.md`](architecture/标签语义引擎与Agent编排层.md) | 对照代码整理：`ts_*` 语义层、快照/索引、六通道检索、LangGraph 受控选择图与 DSL 门禁；含本机启动与运营使用指南 | 现行（2026-09-19 代码事实） |
